...
def extract_audio(video_path, audio_path):
    try:
        ...
        ffmpeg_path = 'C:/Users/user/LnB/Final vedio to text evaluation/Student Evalution using AI/FFMPEG/ffmpeg-2024-04-25-git-cae0f2bc55-full_build/bin/ffmpeg.exe' # Update with the correct path to FFmpeg
...
def index():
    if request.method == 'GET':
        ...
        new_ds = pickle.load(open('preprocess_data_copy.pkl', 'rb'))
